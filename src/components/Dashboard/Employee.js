...
function Employee() {
   ...
   const columns = [
  { field: 'name', headerName: 'Name', flex: 1, minWidth: 140, sortable: true },
  { field: 'mail', headerName: 'Email', flex: 2, minWidth: 200, sortable: true },
  { field: 'designation', headerName: 'Designation', flex: 1, minWidth: 150, sortable: true },
  { field: 'department', headerName: 'Department', flex: 1, minWidth: 120, sortable: true },
  { field: 'location', headerName: 'Location', flex: 1, minWidth: 120, sortable: true },
  { field: 'status', headerName: 'Status', flex: 0.6, minWidth: 80, sortable: true },
  {
    field: 'actions',
    headerName: 'Actions',
    flex: 1.2,
